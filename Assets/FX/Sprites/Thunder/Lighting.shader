...
Shader "Shadero Customs/Lighting"
{
Properties
{
...
_GenerateLightning_Size_1("_GenerateLightning_Size_1", Range( 1, 8)) = 8
_GenerateLightning_Number_1("_GenerateLightning_Number_1", Range(2, 16)) = 16
_GenerateLightning_Speed_1("_GenerateLightning_Speed_1", Range( 0, 8)) = 6.284
