...
_Destroyer_Value_1("_Destroyer_Value_1", Range(0, 1)) = 1
...
float4 _Destroyer_1 = DestroyerFX(_MainTex_2,i.texcoord,_Destroyer_Value_1,_Destroyer_Speed_1,2);
float4 _ShinyFX_1 = ShinyFX(_Destroyer_1,i.texcoord,_ShinyFX_Pos_1,_ShinyFX_Size_1,_ShinyFX_Smooth_1,_ShinyFX_Intensity_1,_ShinyFX_Speed_1);
