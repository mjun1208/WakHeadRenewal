...
public class BattleGround_Aim : ActorSub
{
    ...
    public Vector3 AimPosition
    {
        get
        {
            return _aimObject.transform.position;
        }
        set
        {
            _aimObject.transform.position = value;
        }
    }
    ...
    public void ReduceShootCount()
    {
        ...
        Global.PoolingManager.LocalSpawn("SnipeHitEffect", _aimObject.transform.position, Quaternion.identity, true);
    }
